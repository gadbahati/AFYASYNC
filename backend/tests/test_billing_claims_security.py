...
from app.billing.service import BillingError, process_payment_callback, record_payment
from app.claims.service import ClaimsError, submit_claim
from app.integrations.adapters import AdapterResult, HttpJsonAdapter, UnconfiguredAdapter, build_adapter
from app.billing.service import _build_payment_submission_payload
...
def test_payment_callback_confirms_and_updates_invoice() -> None:
    ...
    db.scalars.return_value = []
    with patch("app.billing.service.notify_patient_event"):
