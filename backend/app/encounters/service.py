...
def _require_active_context(db: Session, patient_id: UUID, facility_id: UUID, department_id: UUID) -> None:
    ...
    # Architecture rule: clinical work requires active enrollment at this facility
    ...
    *,
    ...
    if actor_user_id:
        record_audit(
            ...
            metadata={"encounter_id": encounter.encounter_id, "encounter_type": encounter.encounter_type},
            commit=False,
        )
    if commit:
        db.commit()
