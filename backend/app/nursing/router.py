...
def _error(exc):
    codes={"PATIENT_NOT_IN_FACILITY":status.HTTP_403_FORBIDDEN,"ENCOUNTER_NOT_OPEN":status.HTTP_400_BAD_REQUEST,"INVALID_PAIN_SCORE":status.HTTP_422_UNPROCESSABLE_ENTITY,"OBSERVATION_EMPTY":status.HTTP_422_UNPROCESSABLE_ENTITY}
    return HTTPException(codes.get(str(exc),400),detail=str(exc))
