...
def get_payers(status_filter: str | None = Query(default=None, alias="status"), db: Session = Depends(get_db), _: User = Depends(require_national_permission("payer.network.read"))) -> list[PayerAdminResponse]:
...
def create_payer(payload: PayerCreate, db: Session = Depends(get_db), user: User = Depends(require_national_permission("payer.network.manage"))) -> PayerAdminResponse:
    try:
...
def update_payer(payer_id: UUID, payload: PayerUpdate, db: Session = Depends(get_db), user: User = Depends(require_national_permission("payer.network.manage"))) -> PayerAdminResponse:
    try:
...
def change_payer_status(payer_id: UUID, payload: PayerStatusUpdate, db: Session = Depends(get_db), user: User = Depends(require_national_permission("payer.network.manage"))) -> PayerAdminResponse:
    try:
...
def get_payer_plans(payer_id: UUID, status_filter: str | None = Query(default=None, alias="status"), db: Session = Depends(get_db), _: User = Depends(require_national_permission("payer.network.read"))) -> list[PayerPlanAdminResponse]:
    try:
...
def create_payer_plan(payer_id: UUID, payload: PayerPlanCreate, db: Session = Depends(get_db), user: User = Depends(require_national_permission("payer.network.manage"))) -> PayerPlanAdminResponse:
    try:
...
def update_payer_plan(plan_id: UUID, payload: PayerPlanUpdate, db: Session = Depends(get_db), user: User = Depends(require_national_permission("payer.network.manage"))) -> PayerPlanAdminResponse:
    try:
...
def change_payer_plan_status(plan_id: UUID, payload: PayerPlanStatusUpdate, db: Session = Depends(get_db), user: User = Depends(require_national_permission("payer.network.manage"))) -> PayerPlanAdminResponse:
    try:
