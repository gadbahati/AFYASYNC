...
def _error(exc: ClaimsError) -> HTTPException:
    mapping = {
        ...
        "INVALID_APPROVED_AMOUNT": 400, "APPROVED_AMOUNT_EXCEEDS_CLAIM": 400, "INVALID_RECEIVED_AMOUNT": 400,
        "INVOICE_VOID": 409, "CLAIM_AMOUNT_INVALID": 400, "CLAIM_AMOUNT_MISMATCH": 409,
    }
