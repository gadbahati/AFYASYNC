...
def _error(exc: PreAuthorizationError) -> HTTPException:
    ...
    mapping = {
        ...
        "COVERAGE_NOT_ACTIVE": 409,
        "COVERAGE_EXPIRED": 409,
        "PAYER_NOT_ACTIVE": 409,
        "BENEFIT_NOT_CONFIGURED": 409,
        "ENCOUNTER_NOT_OPEN": 409,
        "SHA_PAYER_REQUIRED": 400,
        "BENEFIT_PACKAGE_NOT_FOUND": 400,
        "INPATIENT_SHA_PACKAGE_REQUIRED": 400,
        "PREAUTH_NOT_DECIDABLE": 409,
        "APPROVED_AMOUNT_EXCEEDS_REQUEST": 400,
