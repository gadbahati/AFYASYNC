...
class ImagingReportResponse(BaseModel):
    id: UUID; order_id: UUID; performed_by: UUID | None; findings: str; impression: str | None; reported_at: datetime; reviewed_by: UUID | None; reviewed_at: datetime | None; report_status: str
    model_config = {"from_attributes": True}
