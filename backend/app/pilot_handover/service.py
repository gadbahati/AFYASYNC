"""Consolidated pilot evidence + county handover artefacts."""
...
def pilot_evidence_pack(
    ...
    evidence_checklist = [
        ...
        {"id": "E15", "item": "Live SHA credentials", "status": "OPERATOR_OWNED"},
        {"id": "E16", "item": "External penetration test", "status": "PENDING_EXTERNAL"},
        {"id": "E17", "item": "DHA portal certification filing", "status": "PENDING_EXTERNAL"},
        {"id": "E18", "item": "County operational sign-off", "status": "HANDOVER"},
    ]

    endpoint_index = [
        "/api/v1/rollout/pilot-evidence",
...
def county_handover_pack(db: Session, *, county: str) -> dict:
    ...
    handover_steps = [
        ...
        {"id": "H05", "step": "Record production readiness GREEN on /api/v1/production/readiness"},
        {"id": "H06", "step": "Export warehouse county facts CSV for baseline metrics"},
