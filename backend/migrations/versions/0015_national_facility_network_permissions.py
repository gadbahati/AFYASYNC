"""add explicitly privileged national facility network permissions

Revision ID: 0015_national_facility_network_permissions
...
revision = "0015_national_facility_network_permissions"
...
PERMISSIONS = (
    ("facilities.network.read", "View the national facility network directory"),
    ("facilities.network.manage", "Create and manage national facility network records"),
)
...
def upgrade() -> None:
    ...
    if role_id is None:
        raise RuntimeError("NATIONAL_ADMIN_ROLE_NOT_FOUND")
