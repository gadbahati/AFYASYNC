"""add patient registration permission

Revision ID: 0014_patient_create_permission
...
revision = "0014_patient_create_permission"
    ...
    if permission_id is None:
        ...
        bind.execute(
            sa.insert(permissions).values(
                ...
                description="Register new patient identities",
            )
        )
