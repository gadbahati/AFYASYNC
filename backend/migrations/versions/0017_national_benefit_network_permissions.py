"""add explicit national benefit configuration permissions

Revision ID: 0017_national_benefit_network_permissions
Revises = 0016_payer_network_permissions
"""
...
revision = "0017_national_benefit_network_permissions"
down_revision = "0016_payer_network_permissions"
branch_labels = None
depends_on = None

PERMISSIONS = (
    ("benefit.network.read", "View national payer benefit configuration"),
    ("benefit.network.manage", "Manage national payer benefit configuration"),
)
