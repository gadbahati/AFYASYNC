"""add patient record read permission

Revision ID: 0016_patient_record_permission
...
revision = "0016_patient_record_permission"
down_revision = "0015_patient_facility_scope"
branch_labels = None
depends_on = None

PERMISSION_CODE = "patients.record.read"
ROLE_NAMES = {
    "Reception",
    "Doctor",
    "Nurse",
    ...
    if permission_id is None:
        ...
        bind.execute(
            sa.insert(permissions).values(
                ...
                description="Read patient demographic records within the active facility",
            )
        )

    for role_id, _ in bind.execute(
