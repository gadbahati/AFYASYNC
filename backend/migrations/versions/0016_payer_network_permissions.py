"""add national payer network administration permissions

Revision ID: 0016_payer_network_permissions
Revises: 0015_national_staff_network_permissions
"""
...
revision = "0016_payer_network_permissions"
down_revision = "0015_national_staff_network_permissions"
branch_labels = None
depends_on = None

PERMISSIONS = (
    ("payer.network.read", "View the national payer registry and plans"),
    ("payer.network.manage", "Manage national payer registry, plans and lifecycle"),
)
