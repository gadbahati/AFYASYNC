"""add allergy clinical safety permissions

Revision ID: 0070_allergy_permissions
Revises: 0069_allergies
"""
...
revision = "0070_allergy_permissions"
down_revision = "0069_allergies"
branch_labels = None
depends_on = None

DEFINITIONS = {
    "clinical.allergy.read": {"Reception", "Nurse", "Doctor", "Clinical Officer", "Hospital Administrator", "System Administrator"},
    "clinical.allergy.write": {"Nurse", "Doctor", "Clinical Officer", "Hospital Administrator", "System Administrator"},
}
