  ...
  return (
    <div className="app-shell">
      <aside className="sidebar" aria-label="Primary navigation">
        <div className="brand brand-row"><div className="brand-mark"><KenyaCrest /></div><div className="brand-copy"><strong>AfyaSync</strong><span>National health platform</span></div></div>
        <div className="institution-strip"><span>KENYA</span><strong>Healthcare, connected.</strong></div>
