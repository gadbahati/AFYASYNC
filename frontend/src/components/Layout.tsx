...
const navGroups = [
  { label: "Overview", links: [["/", "Dashboard"], ["/command-centre", "Command centre"], ["/national-command-centre", "National command centre"], ["/national-facilities", "Facility network"], ["/national-staff", "Staff network"], ["/national-payers", "Payer network"], ["/national-benefits", "Benefit configuration"], ["/coverage-simulator", "Coverage simulator"]] },
  ...
  { label: "Revenue & financing", links: [["/billing", "Billing"], ["/claims", "Claims & rework"]] },
] as const;
