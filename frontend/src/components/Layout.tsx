...
const navGroups = [
  { label: "Overview", links: [["/", "Dashboard"], ["/command-centre", "Command centre"], ["/national-command-centre", "National command centre"], ["/national-facilities", "Facility network"], ["/national-staff", "Staff network"], ["/coverage-simulator", "Coverage simulator"]] },
