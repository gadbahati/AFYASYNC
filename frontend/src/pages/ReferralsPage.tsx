...
export function ReferralsPage() {
  ...
  async function onCreate(e: FormEvent) {
    ...
    try {
      const referral = await api.createReferral({ encounter_id: form.encounter_id.trim(), destination_facility_id: form.destination_facility_id, reason: form.reason.trim(), priority: form.priority, clinical_summary: form.clinical_summary.trim() || null });
      await api.createTransfer({ encounter_id: referral.encounter_id, destination_facility_id: referral.destination_facility_id, referral_id: referral.id, reason: referral.reason, notes: referral.clinical_summary });
      setMessage("Referral and transfer request sent. The receiving facility must accept before the patient is transferred.");
