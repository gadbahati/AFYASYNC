      ...
      <div className="portal-shell">
        <div className="portal-card">
          ...
          <div className="portal-actions">
            ...
            <Link to="/portal/continuity-card" className="portal-tile">
              <strong>Continuity card</strong>
              <p className="muted small">QR wallet — allergies & shared history only with your consent</p>
            </Link>
            <Link to="/portal/consents" className="portal-tile">
              <strong>Sensitive disclosure</strong>
              <p className="muted small">
                {consentsCount != null ? `${consentsCount} consent record(s)` : "Control what other hospitals can see"}
              </p>
            </Link>
            <Link to="/portal/coverage" className="portal-tile">
              <strong>Coverage</strong>
              <p className="muted small">SHA / payer membership status</p>
            </Link>
          </div>
